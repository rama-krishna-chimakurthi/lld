package com.rk.behavioralpatterns.observer.notifymefeature;

import com.rk.behavioralpatterns.observer.notifymefeature.observable.IphoneProductObservable;
import com.rk.behavioralpatterns.observer.notifymefeature.observable.StockAvailabilityObservable;
import com.rk.behavioralpatterns.observer.notifymefeature.observer.EmailNotificationObserver;
import com.rk.behavioralpatterns.observer.notifymefeature.observer.PushNotificationObserver;
...
public class ECommerceStockNotificationApp {
    public static void main(String[] args) {
        ...
        if (!success) {
            // Register observers - John, Katy, Jane, George subscribe to notifications upon
            // stock availability
